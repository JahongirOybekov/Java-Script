...
const oqBlok = document.createElement("div");
document.body.append(oqBlok);
oqBlok.id = "konteyner";
...
konteyner.style.backgroundColor = "white";
konteyner.style.width = "95%";
konteyner.style.padding = "30px";
konteyner.style.borderRadius = "20px";
konteyner.style.border = "2px solid black";
konteyner.style.display = "flex";
konteyner.style.justifyContent = "space-around";
konteyner.style.gap = "15px";

konteyner.innerHTML = `
  

    <div style="width: 320px; height: 400px; padding: 15px; border: 2px solid black; overflow-y: scroll; border-top-left-radius: 20px; border-bottom-left-radius: 20px;">
